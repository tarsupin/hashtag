...
/****** Search through the official hashtag list ******/
	...
	)				// RETURNS <int:[str:mixed]> list of relevant hashtags, array() if failed.
...
/****** Create (or update) an official Hashtag ******/
	...
	(
		$hashtag			// <str> The official hashtag to create (or update), e.g. "GBPackers"
	,	$title				// <str> The title used for this hashtag, e.g. "Green Bay Packers"
	,	$keywords			// <str> Any additional keywords to apply, e.g. "Lambeau Field"
	,	$primaryURL			// <str> The primary url that this hashtag is associated with.
	,	$disambiguate = ""	// <str> If the title has multiple meanings, this can be used to distinguish it.
	,	$description = ""	// <str> The description of this official hashtag, if applicable.
	)						// RETURNS <bool> TRUE if the official hashtag is set, FALSE on error.
