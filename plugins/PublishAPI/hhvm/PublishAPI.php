...
/****** API Variables ******/
	...
	public int $minClearance = 6;			// <int> The minimum level of clearance required to access this API.
	
	
/****** Run the API ******/
	public function runAPI (
	): bool					// RETURNS <bool> TRUE if the submission succeeded, FALSE if not.
...
/****** Run the re-submission API ******/
	...
	(
		array <int, str> $hashtags		// <int:str> The list of hashtags being submitted.
	,	string $thumbnail		// <str> The URL of the thumbnail sent ("" if none).
	,	string $videoURL		// <str> The URL of the video that was used in the original ("" if none).
	,	string $sourceURL		// <str> The URL that was used as the original source to return to.
	): bool					// RETURNS <bool> TRUE if the resubmission succeeded, FALSE if not.
