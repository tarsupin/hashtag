...
/****** Get Recent Hashtags (the full list) ******/
	...
	(
		int $page = 1		// <int> The page to retrieve of trending posts.
	,	int $showNum = 10	// <int> The number of trending posts to show on each page.
	): array <int, array<str, mixed>>					// RETURNS <int:[str:mixed]> list of the most recent submissions, or empty array if failed.
...
/****** Get the current trending tags ******/
	...
	): array <int, str>			// RETURNS <int:str> list of trending hashtags, or empty array if failed.
