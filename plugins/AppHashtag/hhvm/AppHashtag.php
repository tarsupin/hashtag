...
/****** Get Hashtags ******/
	...
	(
		int $hashtagID		// <int> Choose the hashtag to retrieve (by ID).
	,	mixed $type = "*"		// <mixed> The type of hashtags to refine the search by (* is all).
	,	int $page = 1		// <int> The page that you're going to retrieve submissions of.
	,	int $showNum = 10	// <int> The number of submissions to show on each page.
	): array <int, array<str, mixed>>					// RETURNS <int:[str:mixed]> list of the most recent submissions, array() if failed.
...
/****** Get the hashtag ID ******/
	...
	(
		string $hashtag			// <str> The hashtag (as a string).
	,	bool $create = false		// <bool> TRUE if you want to create the hashtag if it doesn't exist yet.
	): int						// RETURNS <int> ID of the hashtag if discovered (or created successfully), 0 otherwise.
...
/****** Create a Hashtag ******/
	...
	(
		string $hashtag		// <str> The hashtag (as a string).
	): int					// RETURNS <int> ID of the hashtag if created successfully (or exists), 0 otherwise.
...
/****** Display the list of hashtag submissions ******/
	...
	(
		array <int, array<str, mixed>> $submissions	// <int:[str:mixed]> The full submission list to display.
	): void					// RETURNS <void> OUTPUTS the content.
